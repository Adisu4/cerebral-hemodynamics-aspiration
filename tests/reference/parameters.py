"""Frozen parameter definitions for the publication rerun.
...
def make_reference_parameters() -> PublicationParameters:
    return PublicationParameters()


def make_tbi_parameters() -> PublicationParameters:
...
__all__ = ["PublicationParameters", "make_reference_parameters", "make_tbi_parameters"]
