...
| Figure 3: grouped ICP reduction by extraction and return rate | `figure_03_flow_response_svc_return` |
...
The flow-response plot displays the complete dose series as baseline minus
final ICP; its numerical values and final ICP are also available in Extended
Data Table 1. Figure 4 displays only venous pressures because Figure 3 already
presents the ICP response. The PDFs are vector
